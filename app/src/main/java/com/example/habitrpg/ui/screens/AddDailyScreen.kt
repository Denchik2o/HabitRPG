...
fun AddDailyScreen(
    ...
    var selectedDays by remember { mutableStateOf(emptySet<WeekDay>()) }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Новая ежедневная задача") },
                navigationIcon = {
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    OutlinedTextField(
                        ...
                        singleLine = true,
                        placeholder = { Text("Например: Вечерняя прогулка") },
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                if (isTitleValid && selectedDays.isNotEmpty()) {
                                    onSaveDaily(
                                        title.trim(),
                                        description.trim(),
                                        selectedDifficulty,
                            ...
                            enabled = isTitleValid && selectedDays.isNotEmpty()
                        ) {
                            Text("Создать задачу")
                        }
                    }
...
fun WeekDaySelector(
    ...
    onDaysChanged: (Set<WeekDay>) -> Unit,
    modifier: Modifier = Modifier
) {
    Row(
        modifier = modifier.fillMaxWidth(),
